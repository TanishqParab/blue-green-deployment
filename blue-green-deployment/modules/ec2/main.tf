...
resource "aws_instance" "blue" {
  ...
  provisioner "file" {
    source      = "C:/Users/Tanishq.Parab/Desktop/Projects/blue-green-deployment/modules/ec2/scripts/install_dependencies.sh"
    destination = "/home/ec2-user/install_dependencies.sh"
  }

  provisioner "file" {
    source      = "C:/Users/Tanishq.Parab/Desktop/Projects/blue-green-deployment/modules/ec2/scripts/app.py"
    destination = "/home/ec2-user/app.py"
  }

  provisioner "file" {
    source      = "C:/Users/Tanishq.Parab/Desktop/Projects/blue-green-deployment/Jenkinsfile"
